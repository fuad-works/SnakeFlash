package org.flixel
{
	 ...
	 * @author	Adam Atomic
	 */
	public class FlxArText extends FlxSprite
	{
		 ...
		 */
		public function FlxArText(X:Number, Y:Number, Width:uint, Text:String=null, EmbeddedFont:Boolean=true)
		{
			super(X,Y);
			...
			_textField.text = Ar.GetCorrectArabic(Text);
			var format:TextFormat;
			format = new TextFormat("ArSystem", 8, 0xffffff);
			format.align = "right";
		 ...
		 */
		public function setFormat(Font:String=null,Size:Number=8,Color:uint=0xffffff,Alignment:String=null,ShadowColor:uint=0):FlxArText
		{
			if(Font == null)
				Font = "";
